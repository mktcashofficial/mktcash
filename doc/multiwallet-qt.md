...
In order to support loading of multiple wallets in mktcash-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is mktcash.cpp.
...
Changes to mktcash.cpp
----------------------
mktcash.cpp is the entry point into mktcash-qt, and as such, will require some minor modifications to provide hooks for
