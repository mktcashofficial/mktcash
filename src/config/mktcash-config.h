/* src/config/mktcash-config.h.  Generated from mktcash-config.h.in by configure.  */
/* src/config/mktcash-config.h.in.  Generated from configure.ac by autoheader.  */
...
#define PACKAGE_BUGREPORT "mktcash.io"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Mktcash Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Mktcash Core 1.0.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "mktcash"
