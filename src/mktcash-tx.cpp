...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Mktcash Core mktcash-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  mktcash-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded mktcash transaction") + "\n" +
                               "  mktcash-tx [options] -create [commands]   " + _("Create hex-encoded mktcash transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded mktcash transaction
