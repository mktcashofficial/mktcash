...
leveldb groups admktcashent keys together into the same block and such a block is
...
Note that the unit of disk transfer and caching is a block. Admktcashent keys
