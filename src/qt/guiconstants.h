...
/* Mktcash GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "MCH"
#define QAPP_ORG_DOMAIN "mktcash.org"
#define QAPP_APP_NAME_DEFAULT "Mktcash-Core"
#define QAPP_APP_NAME_TESTNET "Mktcash-Core-testnet"
