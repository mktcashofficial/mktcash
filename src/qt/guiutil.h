...
/** Utility functions used by the MCH Qt UI.
 */
namespace GUIUtil
{
...
// Render MCH addresses in monospace font
...
// Parse "mktcash:" URI into recipient object, return true on successful parsing
