...
#   c) node1 mines 32 blocks, so now node 0 has 60001mktcash, node 1 has 4250mktcash, node2 has none.
#   d) node0 sends 601 mktcash to node2, in two transactions (301 mktcash, then 300 mktcash).
