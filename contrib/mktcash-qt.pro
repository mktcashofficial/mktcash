...
RESOURCES += src/qt/mktcash.qrc src/qt/mktcash_locale.qrc

TRANSLATIONS += src/qt/locale/mktcash_bg.ts \
                src/qt/locale/mktcash_de.ts \
                src/qt/locale/mktcash_en.ts \
                src/qt/locale/mktcash_es.ts \
                src/qt/locale/mktcash_fi.ts \
                src/qt/locale/mktcash_fr.ts \
                src/qt/locale/mktcash_it.ts \
                src/qt/locale/mktcash_ja.ts \
                src/qt/locale/mktcash_pl.ts \
                src/qt/locale/mktcash_pt.ts \
                src/qt/locale/mktcash_ru.ts \
                src/qt/locale/mktcash_sk.ts \
                src/qt/locale/mktcash_sv.ts \
                src/qt/locale/mktcash_vi.ts \
                src/qt/locale/mktcash_zh_CN.ts \
                src/qt/locale/mktcash_zh_TW.ts
