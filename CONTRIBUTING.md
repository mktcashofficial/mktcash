Contributing to Mktcash Core
============================

The Mktcash Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Mktcash Core project, and is not to be
confused with overall MCH Network Protocol consensus changes.

Whether a pull request is merged into Mktcash Core rests with the project merge
...
Patches that change MCH consensus rules are considerably more involved than
...
Where a patch set proposes to change the MCH consensus, it must have been
...
The project leader is the release manager for each Mktcash Core release.
